<template>
    <div class="print-div printDrag" ref="printContainer">
        <calcite-button appearance="transparent" iconStart="x" class="print-div__close" @click="$emit('closePrint')"></calcite-button>
    </div>
</template>
